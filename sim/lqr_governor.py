...
class LqrReferenceGovernor:
    def __init__(self, dt, control_cfg, args):
        ...
        self.yaw_rate_accel = abs(args.keyboard_yaw_rate_accel if args.keyboard_yaw_rate_accel is not None else keyboard_cfg.get("yaw_rate_accel_radps2", 1.5))
        self.yaw_rate_release_accel = abs(args.keyboard_yaw_rate_release_accel if args.keyboard_yaw_rate_release_accel is not None else keyboard_cfg.get("yaw_rate_release_accel_radps2", self.yaw_rate_accel))
    ...
    def update(self, speed_axis, yaw_axis):
        ...
        if self.instant_stop_on_release and yaw_axis == 0.0:
            self.yaw_dot = 0.0
        else:
